...
// when - then
    ...
    void test2() throws Exception {
        ...
        signupRequestForm.add("username", "홀롤루");
        ...
        mvc.perform(post("/user/signup")
                ...
                .andExpect(status().is3xxRedirection()) // redirection에 해당하는 3xx httpstatus가 나와줘야 한다는 것.
    ...
    void test3() throws Exception {
        ...
        mvc.perform(post("/api/products")
                        ...
                        .principal(mockPrincipal) // 로그인한 것처럼 해주기 위해서.. 위에서 mockPrincipal을 만듦. UsernamePasswordAuthenticationToken의 객체.
                )
                .andExpect(status().isOk())
                .andDo(print());
    }
